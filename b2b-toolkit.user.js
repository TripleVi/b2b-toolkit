...
System.register("./___monkey.entry.js", [],(function(exports,module){'use strict';return{execute:(function(){async function onB2bReady() {
	if (!window.Shopify) return;
	const { bootstrapApp } = await module.import('./bootstrap-CLggSjtE-CECMIyEO.js');
...
System.register("./bootstrap-CLggSjtE-CECMIyEO.js", [],(function(exports){'use strict';return{execute:(function(){exports("bootstrapApp",bootstrapApp);function createStorage(namespace = "app", storage = localStorage) {
